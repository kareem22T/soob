...
Route::middleware([NotVerifiedScreen::class])->group(function () {
    Route::get('/verify-phone', VerifyOtp::class)->name('verify.company.phone');
    Route::get('/edit-phone', EditPhone::class)->name('edit.company.phone');
});

Route::middleware([NotVerifiedScreen::class])->group(function () {
    Route::get('/verify-phone', PagesVerifyOtp::class)->name('verify.user.phone');
    Route::get('/edit-phone', PagesEditPhone::class)->name('edit.user.phone');
});
